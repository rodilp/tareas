...
extension StringProtocol {
    var firstUppercased: String { return self.capitalized }
}
...
class UserController {
    ...
    func initUserList(){
        userList.append(UserModel( name:"CARLOS JOSÉ",fatherSurname:"ROBLES", motherSurname:"GOMES",dni: 78451245,birthDate:"06/08/1995",sex:"M",email:"carlos.roblesg@hotmail.com",qtyBrothers:2))
        userList.append(UserModel( name:"MIGUEL ANGEL",fatherSurname:"QUISPE",motherSurname:"OTERO",dni: 79451654,birthDate:"28/12/1995",sex:"M",email:"miguel.anguel@gmail.com",qtyBrothers:0))
        userList.append(UserModel( name:"KARLA ALEXANDRA",fatherSurname:"FLORES", motherSurname:"ROSAS", dni: 77485812,birthDate:"15/02/1997", sex:"F", email:"Karla.alexandra@hotmail.com",qtyBrothers:1))
        userList.append(UserModel( name:"NICOLAS",fatherSurname:"QUISPE", motherSurname:"ZEBALLOS",dni: 71748552,birthDate:"08/10/1990",sex:"M",email:"nicolas123@gmail.com",qtyBrothers:1))
        userList.append(UserModel( name:"PEDRO ANDRE",fatherSurname:"PICASSO",motherSurname:"BETANCUR",dni: 74823157,birthDate:"17/05/1994",sex:"M",email:"pedroandrepicasso@gmail.com",qtyBrothers:2))
        userList.append(UserModel( name:"FABIOLA MARIA",fatherSurname:"PALACIO", motherSurname:"VEGA",dni: 76758254,birthDate:"02/02/1992",sex:"F",email:"fabi@hotmail.com",qtyBrothers:0))
        addUserNames()
    }
    ...
    func getList() -> [UserModel]{
        return userList
    }
    
    func getListBySex(sex:String) -> [UserModel]{
    ...
    func filterListByQtyBrothers(qty:Int) -> [UserModel]{
